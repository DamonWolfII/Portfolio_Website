...
const About = () => {
  return (
    <div id="about" className="grid grid-cols-1 md:grid-cols-2 p-8 md:p-16 gap-8">
      {/* About Me Section */}
      <div className="p-6 bg-white dark:bg-gray-800 shadow-md rounded-lg h-auto">
        <h1 className="text-2xl font-semibold text-black dark:text-white mb-3">About Me</h1>
        {/* <div className="text-xl font-semibold text-black mb-4">
          <p>Kshitij Bishokarma</p>
          <p>Java Developer</p>
        </div> */}
        <p className="leading-relaxed text-gray-700 dark:text-white text-justify">
          I have around 1+ year of experience as backend developer with domain JAVA.
        </p>
        <p className="leading-relaxed text-gray-700 dark:text-white mt-4 text-justify">
      ...
      {/* Skills Section */}
      <div className="p-6 bg-white dark:bg-gray-800 shadow-md rounded-lg h-auto">
        <h1 className="text-2xl font-semibold text-black dark:text-white mb-3">Skills</h1>
        <div className="grid grid-cols-4 gap-9 justify-items-center items-center">
          ...
          <RiTailwindCssFill size={50} className="text-slate-900 dark:text-black hover:animate-bounce cursor-pointer" />
          <FaGithub size={50} className="text-gray-800 dark:text-black hover:animate-bounce cursor-pointer" />
        ...
        <div className="mt-10">
          <h1 className="text-2xl font-semibold text-black dark:text-white">Education</h1>
          <div className="text-black dark:text-white mt-3">
            <h1>
              <p className="text-xl font-bold text-black dark:text-white">+2 Science</p>
              <p className="text-xl">Liverpool International College </p>
              <p>[ 2017 - 2019 ] </p>
            </h1>
          </div>
          <div className="text-black dark:text-white mt-3">
            <h1>
              <p className="text-xl font-bold text-black dark:text-white">Bachelor in Information Technolgoy</p>
              <p className="text-xl">Phoenix College of Management </p>
              <p>[ 2021 - 2024 ] </p>
            </h1>
          </div>
        </div>
