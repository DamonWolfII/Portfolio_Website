    ...
    <div className='m-6 md:m-16 mt-6 grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-20 items-center p-8'>
      <div className='text-center md:text-left md:pl-16'>
        ...
        <div className='flex gap-5'>
         <button className='inline-block mt-6 bg-green-600 text-white hover:bg-green-700 transition-colors rounded-xl py-2 px-6 ' onClick={()=>window.scroll({
          top: 2000,   
          left: 0,    
          behavior: 'smooth'
        })}>
     Want to work together?
      ...
      <button className='mt-6 bg-green-600 text-white flex gap-2 rounded-xl py-2 px-6 animate-bounce' onClick={handleDownload}>Download CV <FaChevronDown className='mt-1'/>
      </button>
      </div>
</div>
